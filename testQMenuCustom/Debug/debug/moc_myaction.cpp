...
struct qt_meta_stringdata_MyAction_t {
    QByteArrayData data[5];
    char stringdata0[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MyAction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MyAction_t qt_meta_stringdata_MyAction = {
    {
QT_MOC_LITERAL(0, 0, 8), // "MyAction"
QT_MOC_LITERAL(1, 9, 7), // "getText"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 6), // "string"
QT_MOC_LITERAL(4, 25, 8) // "sendText"

    },
    "MyAction\0getText\0\0string\0sendText"
};
...
void MyAction::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyAction::getText)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MyAction::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidgetAction::staticMetaObject>(),
    qt_meta_stringdata_MyAction.data,
    qt_meta_data_MyAction,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *MyAction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyAction.stringdata0))
